  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div className="space-y-1.5 text-sm">
        ...
        <FeatureRow label="Head ⌀" value={features.head?.diameter ? `${features.head.diameter}mm` : "—"} />
        <FeatureRow label="Shank ⌀" value={features.shank?.diameter ? `${features.shank.diameter}mm` : "—"} />
